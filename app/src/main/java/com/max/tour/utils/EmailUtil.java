...
public class EmailUtil {
     ...
     * 自己的邮箱
     */
    public static String account = "zhengchenjob@163.com";
    /**
     * 密码
     */
    public static String password = "zc901028";
    ...
    public static void sendMail(String to, String code) {
        ...
        try {
            ...
            // 3.3设置邮件的主题
            message.setSubject("这是毕业设计中接收验证码的功能");
            // 3.4设置邮件的正文
            message.setContent("<h1>来自毕业设计的验证码是：" + code, "text/html;charset=UTF-8");
            // 4.发送邮件
